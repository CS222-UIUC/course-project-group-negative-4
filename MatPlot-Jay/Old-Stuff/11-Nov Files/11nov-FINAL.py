...
df3 = df3.groupby('Primary Instructor', as_index=False).sum() #as_index or else the Primary Instructor column name gets weird
#print(df3)

df3 = df3.sort_values(by = ['A+', 'A', 'A-', 'B+', 'B', 'B-'])
print(df3)
